...
\resizebox{0.7\textwidth}{!}{
        ...
        \node[rectangle,draw = black,fill=orange!10,minimum height= \nodeinlayersep, minimum width= 5.5 * \layersep, rounded corners] (L_misfit_2) at (6.5*\layersep, -10.5*\nodeinlayersep) { Loss $\mathcal{L} \,\,  = \,\, \halfv{1} \nor{\ub_0 - \ub^*}_2^2 \,\, + \,\, \textcolor{white}{\halfv{\lambda} \nor{\yb - \B \ybfull^{'}}_2^2}$};
