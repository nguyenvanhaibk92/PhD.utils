...
\definecolor{burntorange}{RGB}{191,110,0} %Burnt Orange
...
\newcommand{\mygreen}[1]{{\color[rgb]{0,.65,0} #1}}
\newcommand{\mywhite}[1]{{\color[rgb]{1.0,1.0,1.0} #1}}
\newcommand{\myred}[1]{{\color[rgb]{0.745,0.431,0.0} #1}}
\newcommand{\myblue}[1]{{\color[rgb]{0.0,0.0,1.0} #1}}
...
\newcommand{\ybtest}{\yb^\text{test}}
\newcommand{\ubtest}{\ub^\text{test}}
\newcommand{\zbtest}{\zb^\text{test}}
\newcommand{\GB}{\G^{\B}}
\newcommand{\zb}{\bs{z}}
\newcommand{\ybfulltest}{\bs{\omega}^\text{test}}
\newcommand{\omb}{{\bf \omega}}
\newcommand{\du}{{n}}
\newcommand{\dw}{{p}}
\newcommand{\dy}{{m}}
\newcommand{\ybfull}{\bs{\omega}}
...
\newcommand{\mcENC}{{\texttt{mcENC-}}}
\newcommand{\mcDEC}{{\texttt{mcDEC}}}

\newcommand{\purePOP}{{\texttt{nPOP}}}
\newcommand{\pureOPO}{{\texttt{nAE}}}
\newcommand{\mcPOP}{{\texttt{mcPOP}}}
\newcommand{\mcOPO}{{\texttt{mcAE}}}
\newcommand{\mcOPOfull}{{\texttt{mcOPO-Full}}}
\newcommand{\ResPOP}{{\texttt{resPOP}}}
\newcommand{\ResOPO}{{\texttt{resOPO}}}
\newcommand{\ResTNetOPO}{{\texttt{resTNetOPO}}}
\newcommand{\TNetAE}{{\texttt{TAEN}}}
\newcommand{\TNetAEfull}{{\texttt{TAEN-Full}}}


\newcommand{\fb}{\mathbf{f}}
\newcommand{\DGGNN}{\Psi_{\texttt{DGNet}}}
\newcommand{\MSEdg}[1]{\left\| #1 \right\|_{L^2(\Omega)}^2}

\newcommand{\Lamb}{{\bs{\Lambda}}}
\newcommand{\Gamb}{{\bs{\Gamma}}}
\newcommand{\ycovinv}{\Lamb^{-1}}
\newcommand{\ucovinv}{{\Gamb^{-1}}}

% Define a new environment for left-aligned equations
...
\title{
  {
  Model-Constrained Machine Learning Approach \\ for Forward and Inverse Problems
  }
  }
...
\institute[]{%
  \small
  {Advisor: Prof. Tan Bui-Thanh} \\ 
  \mythemec{\textcolor{burntorange}{P}robabilistic and \textcolor{burntorange}{H}igh \textcolor{burntorange}{O}rder \textcolor{burntorange}{I}nference, \textcolor{burntorange}{C}omputation, \textcolor{burntorange}{E}stimation, and \textcolor{burntorange}{S}imulation Group \\ \textcolor{burntorange}{PHO-ICES} } \\ ~ \\
  % \mythemec{The University of Texas at Austin} \\ ~ \\
  % \vspace{1em}
  ...
  \textcolor{burntorange}{Department of Aerospace Engineering and Engineering Mechanics} \\
  \myorange{The University of Texas at Austin} \\ ~ \\
  % \mysierp{Our research are funded by DOE \& NSF and implemented on TACC} \\ ~ \\
  \mysierp{28 March 2025}
