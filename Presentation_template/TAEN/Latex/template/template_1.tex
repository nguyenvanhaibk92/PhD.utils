...
\author{Hai Nguyen and Tan Bui-Thanh}

\institute[]{%
  \small
  \mythemec{Probabilistic and High Order Inference, Computation, Estimation, and Simulation (PHO-ICES)} \\ ~ \\
  ...
  \myorange{06 March, SIAM CSE 2025}
